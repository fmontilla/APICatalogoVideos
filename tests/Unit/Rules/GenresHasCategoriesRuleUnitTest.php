...
class GenresHasCategoriesRuleUnitTest extends TestCase
{
    ...
    public function testGenresIdValue()
    {
        ...
        $genressId = $reflectionProperty->getValue($rule);
        $this->assertEqualsCanonicalizing([1, 2], $genressId);
    }
    ...
    protected function createRuleMock(array $cateforiesId): MockInterface
    {
        return \Mockery::mock(GenresHasCategoriesRule::class, [$cateforiesId])
            ->makePartial()
